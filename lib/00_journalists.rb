...
def how_many_journalists(journalistes)
  puts "il y a combien de journalistes ?"
  puts "Il y en a #{journalistes.size}"
end
how_many_journalists(journalistes)


def how_many_handle_with_number(journalistes)
  count = 0
  journalistes.each do |email|
      count +=1
  puts "Combien d'handle avec un numero  ?"
  puts "Il y en a #{count}"
end
end

def how_many_handle_aude(journalistes)
	count = 0
	journalistes.each do |email|
	if email.match (/[a,u,d,e]/)
	count +=1
	puts " combien d'handle avec aude ?"
	puts " il y en a #{count}"
endu
end

def how_many_begin_with_maj(journalistes)
	count = 0
	journalistes.each do |email|
	if email.match (/@[A-Z]/)
	count += 1
...
def perform
how_many_journalists(journalistes)
how_many_handle_with_number(journalistes)
how_many_handle_aude(journalistes)
how_many_begin_with_maj(journalistes)
how_many_maj(journalistes)
end
