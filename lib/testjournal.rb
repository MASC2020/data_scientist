...
#Le nombre de journalistes dans la liste @
journalistes = names.grep(/[@]/)
 
 
#Le nombre de handleNumer dans la liste @
handleNumber = names.grep(/[0-9]/)
 
 
#Combien d'handle contiennent les 4 lettres du prénom "Aude" à la suite (sans prendre en compte les majuscules) ?
AudeNumber = names.grep(/aude/)
 
#Combien commencent par une majuscule (première lettre juste après le @) ?
PremiereLettre = names.grep(/[@]{1}[A-Z]{1}/)
 
 
puts "mon filtre #{journalistes}"
puts "counting : #{journalistes.count}\n\n"
 
 
puts "mon filtre handle #{handleNumber}"
puts "counting : #{handleNumber.count}\n\n"
 
 
 
puts "mon filtre Aude #{AudeNumber}"
puts "counting : #{AudeNumber.count}\n\n"
 
 
 
puts "mon filtre Aude #{PremiereLettre }"
puts "PremiereLettre : #{PremiereLettre.count}\n\n"
